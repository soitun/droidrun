...
- `config` _DroidConfig | None_ - Full configuration object (required if llms not provided). Contains agent settings, LLM profiles, device config, and more.
...
#### DroidAgent.send\_user\_message
