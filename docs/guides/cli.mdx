...
<Tip>For first-time setup, use `droidrun configure` to interactively choose your provider and credentials. Environment variables below are useful for overrides and CI/CD.</Tip>
